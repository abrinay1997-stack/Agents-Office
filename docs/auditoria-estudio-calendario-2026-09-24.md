...
**✅ = arreglado** en V4.2 (misma rama, 24 sep): las prioridades de «Por dónde empezar» y algunos vecinos que tocaban el mismo código — 9 del Estudio y 15 del Calendario —, y después la agenda del teléfono (B5), lo que ya pasó (B7) las acciones de la galería (A20, A21), y luego «Mejorar el prompt» (A2), la ventanita de la rutina (B16) el aviso con el Estudio cerrado (A41), y por último el tiempo estimado y el aviso al cancelar (A39, A40), el visor ampliado (A32–A35) DESHACER en el calendario (B21), y los pedidos agrupados, la galería por días, la búsqueda y la tarea de cada imagen de agente (A19, A23–A25) con los días de una rutina y «¿solo esta vez o siempre?» (B23, B30). En total 44; el resto sigue abierto. Cada punto va con su gravedad y con lo que se propone.
