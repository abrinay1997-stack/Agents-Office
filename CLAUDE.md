...
Real image and video generation, for the owner (✦ ESTUDIO in the bar, key E) and for the agents. `media.mjs` is the engine, `estudio-mcp.mjs` the agents' tool, `src/studio.js` the window.
